# Filtres : Gaussien, Bilatéral et Médian
...
def main():
    ...
    images = [original_uint8,noisy_uint8,gaussian_debruitage,bilateral_debruitage,median_debruitage]
    titles = ["original","bruité","flou gaussien","filtre bilatéral","filtre médian"]
